  ...
  return (
    <main className="">
      ...
      <div className="container mx-auto px-4 py-8 ">
        ...
        <p className="py-6">
          Wellknown is a AI Plugin Registry trying to help create an open
          standard for plugins on the web. We are building a registry of plugins
          that follow the standard published by{" "}
          <a
